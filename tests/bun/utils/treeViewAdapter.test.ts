...
describe('TreeView Adapter', () => {
		...
		test('should convert nested nodes with proper paths', () => {
			const nodes: ContentNode[] = [
				createMockContentNode({
					...
					nodeType: 'category',
					children: [
						createMockContentNode({ _id: 'col1', name: 'Collection 1', nodeType: 'collection' }),
						createMockContentNode({ _id: 'col2', name: 'Collection 2', nodeType: 'collection' })
					]
				})
			];
				...
				createMockContentNode({
					...
					children: [
						createMockContentNode({
							...
							name: 'Level 1',
							nodeType: 'category',
							children: [createMockContentNode({ _id: 'level2', name: 'Level 2', nodeType: 'collection' })]
						})
					]
				})
			];
	...
	describe('toFlatContentNodes', () => {
		test('should convert TreeView items to flat ContentNodes', () => {
			const treeItems: TreeViewItem[] = [
				{ id: 'cat1', name: 'Category 1', nodeType: 'category', path: 'cat1', parent: null, icon: 'mdi:folder' },
				{ id: 'col1', name: 'Collection 1', nodeType: 'collection', path: 'cat1.col1', parent: 'cat1', icon: 'mdi:file' }
			];
		...
		test('should calculate order based on sibling position', () => {
			const treeItems: TreeViewItem[] = [
				{ id: 'cat1', name: 'Category 1', nodeType: 'category', path: 'cat1', parent: null },
				{ id: 'cat2', name: 'Category 2', nodeType: 'category', path: 'cat2', parent: null },
				{ id: 'cat3', name: 'Category 3', nodeType: 'category', path: 'cat3', parent: null }
			];
		...
		test('should extract parentId from path', () => {
			const treeItems: TreeViewItem[] = [
				...
				{ id: 'b', name: 'B', nodeType: 'collection', path: 'a.b', parent: 'a' },
				{ id: 'c', name: 'C', nodeType: 'collection', path: 'a.b.c', parent: 'b' }
			];
	...
	describe('recalculatePaths', () => {
		...
		test('should recalculate paths for nested items', () => {
			const items: TreeViewItem[] = [
				{ id: 'parent', name: 'Parent', nodeType: 'category', path: 'x', parent: null, order: 0 },
				{ id: 'child1', name: 'Child 1', nodeType: 'collection', path: 'x.y', parent: 'parent', order: 0 },
				{ id: 'child2', name: 'Child 2', nodeType: 'collection', path: 'x.z', parent: 'parent', order: 1 }
			];
		...
		test('should update order based on sibling position', () => {
			const items: TreeViewItem[] = [
				{ id: 'a', name: 'A', nodeType: 'category', path: 'a', parent: null, order: 5 },
				{ id: 'b', name: 'B', nodeType: 'category', path: 'b', parent: null, order: 3 },
				{ id: 'c', name: 'C', nodeType: 'category', path: 'c', parent: null, order: 1 }
			];
		...
		test('should handle moving item to new parent', () => {
			...
			const items: TreeViewItem[] = [
				{ id: 'parent1', name: 'Parent 1', nodeType: 'category', path: 'parent1', parent: null, order: 0 },
				{ id: 'parent2', name: 'Parent 2', nodeType: 'category', path: 'parent2', parent: null, order: 1 },
				{ id: 'child', name: 'Child', nodeType: 'collection', path: 'parent1.child', parent: 'parent2', order: 0 } // parent changed!
			];
		...
		test('should handle moving item to root level', () => {
			const items: TreeViewItem[] = [
				{ id: 'parent', name: 'Parent', nodeType: 'category', path: 'parent', parent: null, order: 0 },
				{ id: 'child', name: 'Child', nodeType: 'collection', path: 'parent.child', parent: null, order: 1 } // parent set to null (moved to root)
			];
	...
	describe('fromTreeViewData', () => {
		test('should reconstruct nested ContentNode structure', () => {
			const flatItems: TreeViewItem[] = [
				{ id: 'cat1', name: 'Category', nodeType: 'category', path: 'cat1', parent: null },
				{ id: 'col1', name: 'Collection', nodeType: 'collection', path: 'cat1.col1', parent: 'cat1' }
			];
		...
		test('should handle orphaned nodes by placing at root', () => {
			const flatItems: TreeViewItem[] = [{ id: 'orphan', name: 'Orphan', nodeType: 'collection', path: 'missing-parent.orphan', parent: null }];
		...
		test('should maintain structure through toTreeViewData -> toFlatContentNodes', () => {
			const originalNodes: ContentNode[] = [
				createMockContentNode({
					...
					nodeType: 'category',
					children: [
						createMockContentNode({ _id: 'child1', name: 'Child 1', nodeType: 'collection' }),
						createMockContentNode({ _id: 'child2', name: 'Child 2', nodeType: 'collection' })
					]
				})
			];
